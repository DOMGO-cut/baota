...
sleep 3s
clear
echo -e "\033[33m广告位出租 \033[0m"  
echo -e "\033[32m社长推荐IDC：\n1.轻云互联\n官网：www.qingyunl.com\n2.酷番云\n官网：www.kufanyun.com\n3.无忧云\n官网：www.wuyouyun.com\n4.PuzCloud\n官网：www.puzcloud.com\n\n社长推荐机场：\n1.BGPLINK\n官网：www.bgplink.com\033[0m"
echo -e "\033[35m\n若有问题，随时联系社长，欢迎赞助商、广告商投放！\033[0m"  
echo -e "\033[31m该界面即将自动跳转安装界面，耐心等待！ \033[0m"  
sleep 15s
clear
...
Install_Mains(){
    ...
    wget https://download.ccspump.com/install/plugin/shoki_cdn.zip
    unzip shoki_cdn.zip
    rm -rf shoki_cdn.zip
...
+----------------------------------------------------------------------
| The WebPanel URL will be http://SERVER_IP:8088 when installed.
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
	read -p "是否启用宝塔面板加速来缓解服务器压力(y/n): " go;
done
...
echo -e "\033[33mrelease the following port (8088|888|80|443|20|21) in the security group\033[0m"
echo -e "=================================================================="
